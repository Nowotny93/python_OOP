...
class Television(PowerOutletor, HDMIConnector, RCAConnector):
...
class DVDPlayer(PowerOutletor, HDMIConnector):
...
class GameConsole(PowerOutletor, HDMIConnector, EthernetConnector):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(PowerOutletor, EthernetConnector):
    def connect_to_tv(self, television):
